...
import dezinfMan from "../images/page4-img.webp"
...
function Contacts() {
    ...
    const onFinish = (values) => {
        const telegram_bot_id = "7077947189:AAEDmVpN8vR8mE3cRR59vdhIaXXFRYizOok";
        const chat_id = 6514231707;
        const url = `https://api.telegram.org/bot${telegram_bot_id}/sendMessage`;
        const method = 'POST';
        const name = values.username;
        const phone = values.phonenumber;
        const messageContent = `Dezinfeksiya: Ismi: ${name} \nTelefon raqami: ${phone}`;
        axios({
            url: url,
            method: method,
            data: {
                ...
                <div className="page4-background">
                    <div className="page4-card" data-aos="fade-right">
                        ...
                        >
                            ...
                            >
                                <Input placeholder="+998-90-330-73-93"
                                    style={{ height: '50px', backgroundColor: '#F2F2F2' }} />
                            </Form.Item>
                    ...
                    <div className="page4-img none">
                        <img className="page4-imgs" src={dezinfMan} alt="Error" />
                    </div>
                </div>
            </div>
            <div>
                    ...
                    <div className="modal-background">
                        <div className="modal-content" onClick={handleClose}>
                            ...
                            <div className="modal-img">
                                <img style={{ width: '40%' }} src={smile} alt="Error" />
                            </div>
